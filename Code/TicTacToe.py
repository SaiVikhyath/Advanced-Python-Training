...
Code provided by instructor for reference
"""
...
print("line 33 ", type(invertedSpaces))

# ===========DEFINITIONS===========#

'''Spaces'''
spaces = ('UL', 'UM', 'UR', 'CL', 'CM', 'CR', 'BL', 'BM', 'BR')
print("line 39 ", type(spaces))

'''Wins'''
oWin = ('O', 'O', 'O')
xWin = ('X', 'X', 'X')
print("line 45 ", type(oWin), type(xWin))

'''Doubles'''
oDoubles = [(' ', 'O', 'O'), ('O', ' ', 'O'), ('O', 'O', ' ')]
xDoubles = [(' ', 'X', 'X'), ('X', ' ', 'X'), ('X', 'X', ' ')]
print("line 52 ", type(oDoubles), type(xDoubles))

'''Input'''
possibleInput = [key for key in blankBoard]
print("line 57 ", type(possibleInput))
...
corners = ('UL', 'UR', 'BL', 'BR')
sides = ('CL', 'CR', 'UM', 'BM')
print("line 65 ", type(corners), type(sides))
...
print("line 79 ", type(horizontalFlip), type(verticalFlip))
